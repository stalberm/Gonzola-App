    ...
    <div>
      <div className="main-container">
        ...
        >
          ...
          tailored specifically to your schedule, pace, and curiosities. We have
          an ever-growing number of face-to-face locations where our tutors and
          students can meet in person, as well as virtual/remote options for
          most of our custom courses. We offer small group classes on occasion.
        </SubpageSection>
        <SubpageSection
          title="Savant Tutors"
          image="Thomas.png"
        ...
        >
          ...
          tutors must have at least one degree from one of the top ten
        ...
        <SubpageSection
          ...
          orientation="left"
        >
          At <strong>SAVANTS</strong>, we stay true to our roots in the Arts and
          Humanities, and we pride ourselves in offering courses of incomparable
          quality in these areas. Our master classes in cinema, languages and
        ...
        >
          ...
          far, but now need to more fully master a particular subject (usually a
        ...
        >
          ...
          of our students are, simply curious about the world.
        </SubpageSection>
        <SubpageSection
        ...
        >
          ...
          we make every effort to offer such courses in a person-to-person mode.
        </SubpageSection>
        <SubpageSection
        ...
        >
          ...
          popular learning opportunities. Have you ever wanted an expert to walk
          ...
          love? We’ve got you. Typically offered in a six-week format, in our
          book and film clubs, tutor and student create a tailor-made program
          designed to meet your interests and prior training. We frequently
          offer these experiences for families or groups of friends looking to
          take their next gathering to the next level.
        </SubpageSection>
        <SubpageSection
        ...
        >
          ...
          to deepen and develop their skills. Our <strong>SAVANTS</strong>
          WRITING WORKSHOPS provide high-quality feedback from accomplished
          authors. Whether you want to hone your professional writing skills or
          produce a manuscript of original poetry, our writing workshops offer
          all participants a challenging and rewarding experience.
        </SubpageSection>
        <LearnButton
          path="/form"
