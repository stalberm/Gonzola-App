    ...
    <>
      ...
      <div className="main-container">
        <Subpage
          ...
          paragraphs={[
            <>
              At <strong> SAVANTS </strong> we offer virtual custom courses in
              any conceivable subject virtually. Whatever your need, whatever
              your curiosity, we are here to provide a curated educational
              encounter.
            </>,
            <>
            ...
            <>
              ...
              untraditional approach to traditional topics, we can offer tutors
              trained in decolonizing methodologies, who approach learning from
              non-Western, indigenous, and community-based perspectives.
            </>,
            <>
              From anthropology, acarology or apiology to volcanology,
              xenobiology or zoology, at <strong> SAVANTS </strong> you will
              find a tutor to guide you into a learning adventure custom created
              for you.
            </>,
          ]}
        ></Subpage>
